...
var NorrisBot = function Constructor(settings) {
    ...
    this.settings.name = settings.name || 'norrisbot';
...
NorrisBot.prototype._welcomeMessage = function () {
    this.postMessageToChannel(this.channels[0].name, 'Hi there! \n I\'m the Norris Bot. I tell you fun facts about ' +
        'Chuck Norris if you say `Chuck Norris` or `' + this.name + '`. \n BtW, I was developed by the greates person ' +
        'on earth, Tudor-Dan Ravoiu', {
        as_user: true
    })
};
